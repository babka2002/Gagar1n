                    ...
                    <div class="mt-2 space-y-2">
                        <label id="label-consent-personal" for="consent_personal" class="flex items-center gap-2 text-sm text-light cursor-pointer">
                            ...
                            <span class="select-none">
                                Я даю
                                <a href="https://docs.google.com/document/d/1EO5tCIW066XRFSEj6YhP98h4-vYukJM64wO8GWFS64o/edit?tab=t.0" target="_blank" rel="noopener noreferrer" class="underline hover:no-underline">согласие на обработку моих персональных данных</a>
                                и
                                <a href="https://docs.google.com/document/d/1EO5tCIW066XRFSEj6YhP98h4-vYukJM64o/edit?tab=t.uhb10ilbqhs4" target="_blank" rel="noopener noreferrer" class="underline hover:no-underline">ознакомлен с политикой обработки персональных данных</a>.
                            </span>
                        </label>
                        ...
                        <label id="label-consent-terms" for="consent_terms" class="flex items-center gap-2 text-sm text-light cursor-pointer">
                            ...
                            <span class="select-none">
                                ...
                                <a href="https://docs.google.com/document/d/1EO5tCIW066XRFSEj6YhP98h4-vYukJM64o/edit?tab=t.w9ylabe0y0me" target="_blank" rel="noopener noreferrer" class="underline hover:no-underline">Договором оферты</a>,
                                <a href="https://docs.google.com/document/d/1EO5tCIW066XRFSEj6YhP98h4-vYukJM64o/edit?tab=t.3c00bd4tv5hr" target="_blank" rel="noopener noreferrer" class="underline hover:no-underline">правилами клуба</a>
                                и
                                <a href="https://docs.google.com/document/d/1EO5tCIW066XRFSEj6YhP98h4-vYukJM64o/edit?tab=t.fkqj83coh4y9" target="_blank" rel="noopener noreferrer" class="underline hover:no-underline">техникой безопасности</a>.
                            </span>
                        </label>
                        ...
                        <label id="label-consent-marketing" for="consent_marketing" class="flex items-center gap-2 text-sm text-light cursor-pointer">
                            ...
                            <span class="select-none">
                                Даю согласие на
                                <a href="https://docs.google.com/document/d/1EO5tCIW066XRFSEj6YhP98h4-vYukJM64o/edit?tab=t.dien9retn169#heading=h.e60m58davm2q" target="_blank" rel="noopener noreferrer" class="underline hover:no-underline">получение информационных и маркетинговых рассылок</a>.
                            </span>
                        </label>
                    </div>
