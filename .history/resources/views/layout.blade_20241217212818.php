    ...
    <body class="bg-dark">
        ...
        <div class="container px-[1em] my-5 sticky top-4 z-20">
            ...
            <div class="flex items-center justify-between gap-2 relative z-10">
                ...
                <button type="button" class="w-[52px] md:w-[5.4375em] show grayscale-[1] hover:grayscale-0 transition-all">
                    <img src="<s:glide src='/assets/img/лого-джуниор.png' />" alt="" class="block hover:opacity-70 transition-all"/>
                </button>
                <button type="button" class="w-[52px] md:w-[5.4375em] show grayscale-[1] hover:grayscale-0 transition-all">
                    <img src="<s:glide src='/assets/img/джифуд-лого.png' />" alt="" class="block hover:opacity-70 transition-all"></button>
